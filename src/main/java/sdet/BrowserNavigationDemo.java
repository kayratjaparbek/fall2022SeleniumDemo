...
public class BrowserNavigationDemo extends BaseTest{
    ...
    public void test1() {
        ...
        WebElement houseTypeSelector = driver.findElement(By.id("houseTypeSelectList"));
        Select select = new Select(houseTypeSelector);
        ...
        WebElement clickQuotes = driver.findElement(By.xpath(".//button[text()='Compare Quotes']"));
        clickQuotes.click();
